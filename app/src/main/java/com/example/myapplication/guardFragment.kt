...
import com.example.myapplication.databinding.FragmentGuard3Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.ktx.firestore
import com.google.firebase.ktx.Firebase
import kotlinx.android.synthetic.main.fragment_guard3.*
...
lateinit var binding: FragmentGuard3Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentGuard3Binding.inflate(inflater, container, false)
        return binding.root
    }
